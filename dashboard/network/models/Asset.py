...
class Asset(models.Model):
    ...
    obsolescence_date = models.DateField(verbose_name=u"Data de Obsolesc�ncia")
    ...
    substation = models.ForeignKey('network.Substation', verbose_name=u'Subesta��o')
...
class ParameterValue(models.Model):
    ...
    parameter = models.ForeignKey('algorithms.Parameter', verbose_name=u"Par�metro")
    ...
    class Meta:
        verbose_name = u'Valor de Par�metro'
        verbose_name_plural = u'Valores de Par�metro'
