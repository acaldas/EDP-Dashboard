...
class Parameter(models.Model):
    ...
    function = models.ForeignKey('utils.RegressionFunction', null=True, blank=True, verbose_name=u'Função de Regressão')
...
class ValueCorrespondence(models.Model):
    parameter = models.ForeignKey(Parameter, verbose_name=u'Parâmetro')
    value = models.CharField(max_length=200, verbose_name=u'Valor')
    health_index = models.FloatField(verbose_name=u'Índice de Saúde')
    ...
    class Meta:
        verbose_name = u'Correspondência de Valor'
        verbose_name_plural = u'Correspondências de Valor'
